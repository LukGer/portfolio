...
import Scene from "@/components/explorations/dithering/Scene.tsx";
...
We can also apply a different dithering effect like Floyd-Steinberg-Dithering:

<div className="w-full h-96 rounded-lg shadow-lg bg-slate-100 overflow-hidden">
  <DitheredScene client:load type="floydSteinberg" />
</div>

... or Atkinson-Dithering:
